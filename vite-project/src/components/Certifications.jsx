...
const Certifications = () => {
  ...
  return (
    <section
      id="certifications"
      className="section container certifications-section"
    >
          ...
          <div key={cert.title} className="cert-card glass">
            <div className="cert-img-container">
              {cert.image ? (
                ...
                <div className="cert-preview">
                  <span className="cert-preview-type">
                    {cert.previewLabel || "Certificate"}
                  </span>
            ...
            <div className="cert-info">
              ...
              <div className="cert-actions">
                <ExternalButton
                  href={cert.link}
                  className="glow-btn cert-btn"
                  ariaLabel={`View credential for ${cert.title}`}
                >
                  View Credential
                </ExternalButton>
              </div>
